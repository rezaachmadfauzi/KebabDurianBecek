    ...
    class Transaksi extends MY_Controller
    {
        ...
        {$datatransaksi=$this->Transaksi_model->get_all();//panggil ke modell
          $datafield=$this->Transaksi_model->get_field();//panggil ke modell
           ...
           $data = array(
             'content'=>'transaksi/transaksi/transaksi_list',
             'sidebar'=>'transaksi/sidebar',
             'css'=>'transaksi/transaksi/css',
        ...
        public function ajax_list()
      {
        ...
        public function create(){
           $data = array(
             'content'=>'transaksi/transaksi/transaksi_create',
             'sidebar'=>'transaksi/sidebar',
             'action'=>'transaksi/transaksi/create_action',
             'module'=>'transaksi',
             'titlePage'=>'transaksi',
             'controller'=>'transaksi'
            );
        ...
        public function edit($id_transaksi){
          $dataedit=$this->Transaksi_model->get_by_id($id_transaksi);
           $data = array(
             'content'=>'transaksi/transaksi/transaksi_edit',
             'sidebar'=>'transaksi/sidebar',
             'action'=>'transaksi/transaksi/update_action',
             'dataedit'=>$dataedit,
             'module'=>'transaksi',
             'titlePage'=>'transaksi',
             'controller'=>'transaksi'
