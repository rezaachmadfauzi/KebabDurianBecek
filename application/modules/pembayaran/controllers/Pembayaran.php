    ...
    class Pembayaran extends MY_Controller
    {
        ...
        {$datapembayaran=$this->Pembayaran_model->get_all();//panggil ke modell
          $datafield=$this->Pembayaran_model->get_field();//panggil ke modell
           ...
           $data = array(
             'content'=>'pembayaran/pembayaran/pembayaran_list',
             'sidebar'=>'pembayaran/sidebar',
             'css'=>'pembayaran/pembayaran/css',
             'js'=>'pembayaran/pembayaran/js',
        ...
        public function ajax_list()
      {
        ...
        public function create(){
           $data = array(
             'content'=>'pembayaran/pembayaran/pembayaran_create',
             'sidebar'=>'pembayaran/sidebar',
             'action'=>'pembayaran/pembayaran/create_action',
             'module'=>'pembayaran',
             'titlePage'=>'pembayaran',
             'controller'=>'pembayaran'
            );
        ...
        public function edit($id_pembayaran){
          $dataedit=$this->Pembayaran_model->get_by_id($id_pembayaran);
           $data = array(
             'content'=>'pembayaran/pembayaran/pembayaran_edit',
             'sidebar'=>'pembayaran/sidebar',
             'action'=>'pembayaran/pembayaran/update_action',
             'dataedit'=>$dataedit,
             'module'=>'pembayaran',
             'titlePage'=>'pembayaran',
             'controller'=>'pembayaran'
