    ...
    class Supplier extends MY_Controller
    {
        ...
        {$datasupplier=$this->Supplier_model->get_all();//panggil ke modell
          $datafield=$this->Supplier_model->get_field();//panggil ke modell
           ...
           $data = array(
             'content'=>'admin/supplier/supplier_list',
             'sidebar'=>'admin/sidebar',
             'css'=>'admin/supplier/css',
             'js'=>'admin/supplier/js',
        ...
        public function ajax_list()
      {
        ...
        public function create(){
           $data = array(
             'content'=>'admin/supplier/supplier_create',
             'sidebar'=>'admin/sidebar',
             'action'=>'admin/supplier/create_action',
             'module'=>'admin',
             'titlePage'=>'supplier',
             'controller'=>'supplier'
            );
        ...
        public function edit($id_supplier){
          $dataedit=$this->Supplier_model->get_by_id($id_supplier);
           $data = array(
             'content'=>'admin/supplier/supplier_edit',
             'sidebar'=>'admin/sidebar',
             'action'=>'admin/supplier/update_action',
             'dataedit'=>$dataedit,
             'module'=>'admin',
             'titlePage'=>'supplier',
             'controller'=>'supplier'
