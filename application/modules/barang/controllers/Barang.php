    ...
    class Barang extends MY_Controller
    {
        ...
        {$databarang=$this->Barang_model->get_all();//panggil ke modell
          $datafield=$this->Barang_model->get_field();//panggil ke modell
           ...
           $data = array(
             'content'=>'barang/barang/barang_list',
             'sidebar'=>'barang/sidebar',
             'css'=>'barang/barang/css',
             'js'=>'barang/barang/js',
        ...
        public function ajax_list()
      {
        ...
        public function create(){
           $data = array(
             'content'=>'barang/barang/barang_create',
             'sidebar'=>'barang/sidebar',
             'action'=>'barang/barang/create_action',
             'module'=>'barang',
             'titlePage'=>'barang',
             'controller'=>'barang'
            );
        ...
        public function edit($id_barang){
          $dataedit=$this->Barang_model->get_by_id($id_barang);
           $data = array(
             'content'=>'barang/barang/barang_edit',
             'sidebar'=>'barang/sidebar',
             'action'=>'barang/barang/update_action',
             'dataedit'=>$dataedit,
             'module'=>'barang',
             'titlePage'=>'barang',
             'controller'=>'barang'
